<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosApoderado.aspx.cs" Inherits="TCSWebSite.ContactosApoderado" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/ContactosApoderado.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmContactosApoderado" runat="server" autocomplete="off">
    ...
    <div style="height: 400px"> 
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblApoderado" class="Label" >Apoderado:</label>
                                            </td>
                                            ...
                                            <%--<td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchApoderado" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  --%>
        ...
        <div id="divResults" class="panel" style="display:none;height:auto; width:100%; max-height:180px;">
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentContactoApoderadoTitle">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdApoderado" type="text" class="TextBoxRead" maxlength="10" style="width:250px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                     <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <div id="btnSearchNewApoderado" style="cursor:hand;" class="ButtonLupa" onclick="onSearchNewApoderadoClick()">...</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>  
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentNombreApoderado" type="text" class="TextBoxRead" maxlength="100" style="width:250px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentDireccion1" type="text" class="TextBoxWrite" maxlength="100" style="width:250px" />
                                    </td>   
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentDireccion2" type="text" class="TextBoxWrite" maxlength="100" style="width:250px" />                        </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTelefono1" type="text" class="TextBoxWrite" maxlength="100" style="width:180px"/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTelefono2" type="text" class="TextBoxWrite" maxlength="100" style="width:180px"/>
                                    </td>   
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEmail" type="text" class="TextBoxWrite" maxlength="100" style="width:180px"/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="120px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentObs" type="text" class="TextBoxWrite" maxlength="100" style="width:180px;height:60px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr> 
    ...
    <div id="divSearchContactosPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblContactosApoderadosPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                ...
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchApoderadoFilter" class="Label" >Apoderado:</label>
                                                </td>
                                                <td>
                                                    <input id="txtSearchApoderadoFilter" class="TextBoxWrite" type="text"  
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="Label11" class="Label" >Nombres:</label>
                                                </td>
                                                <td>
