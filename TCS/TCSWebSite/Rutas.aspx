<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rutas.aspx.cs" Inherits="TCSWebSite.Rutas" validateRequest="false"%>
...
<body onload="onFormLoad();">
    <form id="frmRutas" runat="server" autocomplete="off">
    ...
    <div style="height: 400px"> 
            ...
            <table border="0px" cellpadding="0px" cellspacing="0px">
                <tr align="left">
                    <td class="LabelWhite" style="font-size:medium; padding:2px;">
                        <div id="btnNew" class="linkButton"style="width:90px;" onclick="onNewButtonClick();">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtIdRuta" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <%--<td>
                                       ...
                                       <%-- <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtRutaDesc" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                        ...
                                        <tr style="display:none;">
                                            <td align="right" width="120px">
                                                <label id="lblTrayecto" class="Label" >Estudiante:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtEstudianteId" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <%--<td>
                                        ...
                                        <%--<tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtEstudianteNombre" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
        ...
        <div id="divResults" class="panel" style="height:auto; width:100%; max-height:170px;">
                    ...
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center" style="width:100px">
                                <label id="lblSRIdTrayecto" runat="server">Id Ruta</label>
                            </th>
                            <th align="center" style="width:200px">
                                <label id="lblSRTrayecto" runat="server">Descripcion</label>
                            </th>
                            <th align="center" style="width:300px">
                                <label id="lblSRIdContacto" runat="server">Observaciones</label>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentContactoTrayectoTitle">
                        Ruta Seleccionada
                    </td>
                    <td align="right">
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label1" class="Label" >Id Ruta:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdRuta"  type="text" class="TextBoxRead" maxlength="10" style="width:50px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label3" class="Label" >Descripcion:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentDescripcion"  type="text" class="TextBoxWrite" maxlength="50" style="width:250px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label2" class="Label" >Observaciones:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentObs" type="text" class="TextBoxWrite" maxlength="100" style="width:250px;height:50px;" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>  
                                    <td>
                            ...
                            <%--<table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEstudianteId" type="text" class="TextBoxWrite" maxlength="10" style="width:50px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                    <td>
                                        <table style="margin:0px; height: 17px;" border="0px" align="left" 
                                            ...
                                            <tr>
                                                <td>
                                                    <div id="Div10" style="cursor:hand;" class="ButtonLupa" onclick="onSearchNewEstudianteClick();">...</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEstudianteName" type="text" class="TextBoxRead" maxlength="10" style="width:250px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>    
                                </tr>
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label5" class="Label" >Trayecto:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTrayectoId" type="text" class="TextBoxWrite" maxlength="10" style="width:50px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>  
                                    <td>
                                        <table style="margin:0px; height: 17px;" border="0px" align="left" 
                                            ...
                                            <tr>
                                                <td>
                                                    <div id="Div6" style="cursor:hand;" class="ButtonLupa" onclick="onSearchNewTrayectoClick();">...</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>   
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTrayectoName" type="text" class="TextBoxRead" maxlength="10" style="width:250px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td> 
                                </tr>
    ...
    <div id="divSearchEstudiantesPopup" style="display:none; height:auto; width:610px; max-width: 610px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
     ...
     <%--popup--%>
    <div id="divSearchRutaPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblTrayectosPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Rutas</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td>
                        ...
                        <div id="divSearchDetailTrayectosPopup" class="panel" style="width:557px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
        ...
        <div id="divNewSearchTrayectoPopup" style="display:none;height:auto; width:500px; max-width: 500px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            ...
            <tr>
                ...
                <tr>
                    <td>
                        ...
                        <div id="divNewSearchDetailTrayectoPopup" class="panel" style="width:498px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="Label9" class="Label" >Destino:</label>
                                                </td>
                                                <td>
