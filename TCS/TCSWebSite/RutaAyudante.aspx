<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RutaAyudante.aspx.cs" Inherits="TCSWebSite.RutaAyudante" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/RutaAyudante.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmAyudantes" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblAyudante" class="Label" >Ruta:</label>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label1" class="Label" >Ayudante:</label>
                                            </td> 
                                            <td style="padding-left:5px">
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="Label5" runat="server">Id</label>
                            </th>
                            <th align="center">
                                <label id="lblSRAyudanteId" runat="server">Ruta</label>
                            </th>
                            <th align="center">
                                <label id="Label3" runat="server">Trayecto</label>
                            </th>
                            <th align="center">
                                <label id="lblSRRut" runat="server">Ayudante</label>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentAyudanteTitle">
                        Ruta Ayudante Seleccionado
                    </td>
                    <td align="right">
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label9" class="Label" >Ayudante:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentAyudante" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                    <td style="width:5px;  padding-left:0px;" align="left">&nbsp;</td>  
    ...
    <%--popup--%>
    <div id="divSearchAyudantesPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblAyudantesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="style6">
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Ruta Ayudante</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td class="style6">
                        ...
                        <div id="divSearchDetailAyudantesPopup" class="panel" style="width:637px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="lblSearchApellidosFilter" class="Label" >Ayudante:</label>
                                                </td>
                                                <td>
                ...
                <tr>
                    <td class="style6">
                        <div id="divSearchAyudantesPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchAyudantesTableHeader">
                                    <tr>
                                        <th class="style4">
                                            Ruta
                                        </th>
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchAyudantesPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchManufacturersPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
