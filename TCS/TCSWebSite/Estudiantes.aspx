<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Estudiantes.aspx.cs" Inherits="TCSWebSite.Estudiantes" %>
...
<body onload="onFormLoad();">
    <form id="frmEstudiantes" runat="server" autocomplete="off">
    <cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></cc1:ToolkitScriptManager> 
     ...
     <div style="height: 400px"> 
        ...
        <div id="divSearchTitle" style="width:100%;cursor:hand;" class="tdLikeMenu" onclick="CollapseResultsPanel();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style="width:100%">
                <tr>
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblEstudiante" class="Label" >Estudiante:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtEstudianteId" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchEstudiante" style="cursor:hand;" class="ButtonLupa" onclick="onSearchEstudianteClick();">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtApoderado" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSREstudianteId" runat="server">Id</label>
                            </th>
                            <th align="center">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdEstudiante" 
                                            type="text" 
                                            class="TextBoxRead" 
                                            readonly="readonly"
                                            style="width:180px" 
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentRutEstudiante" 
                                            type="text" 
                                            class="TextBoxWrite" 
                                            maxlength="10" 
                                            style="width:180px" 
                                            onblur = "onTxtCurrentRutEstudianteBlur(this);"
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr> 
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label12" class="Label" >Observaciones:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentObs" 
                                            type="text" 
                                            class="TextBoxWrite" 
                                            maxlength="50" 
    ...
    <%--popup--%>
    <div id="divSearchEstudiantesPopup" style="display:none; height:auto; width:auto; max-width: 700px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblEstudiantesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                ...
                <tr>
                    <td>
                        ...
                        <div id="divSearchDetailEstudiantesPopup" class="panel" style="width:700px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
