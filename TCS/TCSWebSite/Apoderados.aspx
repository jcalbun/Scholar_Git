<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Apoderados.aspx.cs" Inherits="TCSWebSite.Apoderados" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/Apoderados.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmApoderados" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtApoderadoId" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtRut" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr> 
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtNombres" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtApellidos" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtEstudiante" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label4" class="Label" >Establecimiento:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtEstablecimiento" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr> 
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label6" class="Label" >Contacto:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtContacto" type="text" class="TextBoxWrite" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>    
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRApoderadoId" runat="server">Id</label>
                            </th>
                            <th align="center">
                            ...
                            <table>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label7" class="Label" >Apoderado:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdApoderado" type="text" 
                                            class="TextBoxRead" readonly="readonly" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentRutApoderado" 
                                            type="text" 
                                            class="TextBoxWrite" 
                                            maxlength="10" 
                                            style="width:180px" 
                                            onblur = "onTxtCurrentRutApoderadoBlur(this);"
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentNombresApoderado" type="text" class="TextBoxWrite" maxlength="50" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentApellidosApoderado" type="text" class="TextBoxWrite" maxlength="50" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label12" class="Label" >Tiene contrato:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="chkCurrentTieneContrato" type="checkbox" tabindex="3"/>
                                    </td>   
                                </tr> 

                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label13" class="Label" >Parentesco:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <select id="ddlParentesco" style="width:180px" onclick="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="Label14" class="Label" >Nombres:</label>
                                                </td>
                                                <td>
