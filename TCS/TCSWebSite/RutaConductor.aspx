<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RutaConductor.aspx.cs" Inherits="TCSWebSite.RutaConductor" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/RutaConductor.js" type="text/javascript"></script>
                            ...
                            <tr id="Tr1">
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label1" class="Label" >Conductor:</label>
                                            </td> 
                                            <td style="padding-left:5px">
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="Label2" runat="server">Id</label>
                            </th>
                            <th align="center">
                            ...
                            <th align="center">
                                <label id="lblSRRut" runat="server">Conductor</label>
                            </th>
                        </tr>
                    </thead>
                </table>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                <td align="right" width="120px">
                                    <label id="Label9" class="Label" >Conductor:</label>
                                </td> 
                                <td style="padding-left:5px">
                                    <input id="txtCurrentConductor" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                        onkeyup  = ""
                                        onchange = ""/>
                                </td>   
                                <td style="width:5px;  padding-left:0px;" align="left">&nbsp;</td>  
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Ruta Conductor</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="lblSearchApellidosFilter" class="Label" >Conductor:</label>
                                                </td>
                                                <td>
