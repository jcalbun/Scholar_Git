<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfilUsuarios.aspx.cs" Inherits="TCSWebSite.PerfilUsuarios" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/PerfilUsuarios.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmUsuarioes" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblUsuario" class="Label" >Perfil:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtCodigoPerfilFilter" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchPerfil" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label1" class="Label" >Usuario:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtCodigoUsuarioFilter" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchUsuario" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>     
        ...
        <div id="divResults" class="panel" style="display:none;height:auto; width:100%; max-height:160px;">
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thUsuarioesFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRUsuarioId" runat="server">Perfil</label>
                            </th>
                            <th align="center">
            ...
            <div id="divSearchResultsTableContainer" style="overflow:auto;width:auto;max-height:145px">
                <table id = "tblUsuarioesResults" class="GridTable" style="width:700px;">
                    <tbody>
                    </tbody>
                </table>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label9" class="Label" >Usuario:</label>
                                    </td> 
                                    <td style="padding-left:5px">
    ...
    <%--popup--%>
    <div id="divSearchUsuarioesPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
               <table id= "tblUsuarioesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="style6">
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Perfil Usuario</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td class="style6">
                        ...
                        <div id="divSearchDetailUsuarioesPopup" class="panel" style="width:637px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="lblSearchApellidosFilter" class="Label" >Usuario:</label>
                                                </td>
                                                <td>
                ...
                <tr>
                    <td class="style6">
                        <div id="divSearchUsuarioesPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchUsuarioesTableHeader">
                                    <tr>
                                        <th class="style4">
                                            Perfil
                                        </th>
