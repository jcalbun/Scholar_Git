<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApoderadoEstudiante.aspx.cs" Inherits="TCSWebSite.ApoderadoEstudiante" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/ApoderadoEstudiante.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmApoderadoEstudiante" runat="server" autocomplete="off">
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRIdApoderado" runat="server">Id Apoderado</label>
                            </th>
                            <th align="center">
                                <label id="lblSRApoderado" runat="server">Apoderado</label>
                            </th>
                            <th align="center">
                                <label id="lblSRIdEstudiante" runat="server">Id Estudiante</label>
                            </th>
                            <th align="center">
                                <label id="Label4" runat="server">Estudiante</label>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentEstudianteApoderadoTitle">
                        Apoderado Estudiante Seleccionado
                    </td>
                    <td align="right">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdApoderado" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <div id="Div7" style="cursor:hand;" class="ButtonLupa" onclick=" onSearchNewApoderadoClick();">...</div>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>  
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdEstudiante" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEstudiante" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="Label5" class="Label" >Nombres:</label>
                                                </td>
                                                <td>
