<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Minibuses.aspx.cs" Inherits="TCSWebSite.Minibuses" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/Minibuses.js" type="text/javascript"></script>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtId" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right" width="220px">
                                                <label id="Label1" class="Label" >Nro Patente:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtPatente" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr> 
                                        <tr>
                                            <td align="right" width="220px">
                                                <label id="Label2" class="Label" >Marca:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtMarca" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                                        <tr>
                                            <td align="right" width="220px">
                                                <label id="Label4" class="Label" >Modelo:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtModelo" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                                        <tr>
                                            <td align="right" width="220px">
                                                <label id="Label5" class="Label" >Año:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtAno" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            ...
                            <th align="center">
                                <label id="lblSRDescripcion" runat="server">Patente</label>
                            </th>
                            <th align="center">
                                <label id="lblSRDireccion" runat="server">Marca</label>
                            </th>
                            <th align="center">
                                <label id="Label6" runat="server">Modelo</label>
                            </th>
                        </tr>
                    </thead>
                </table>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentId" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label8" class="Label" >Nro Patente:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentPatente" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label9" class="Label" >Marca:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentMarca" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label10" class="Label" >Modelo:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentModelo" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                 <tr>
                                   <td align="right" width="220px">
                                        <label id="Label3" class="Label" >Año:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                 ...
                                 <tr>
                                    <td align="right" width="220px">
                                        <label id="Label13" class="Label" >Combustible:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <select id="ddlCombustible" style="width:180px" onclick="">
                                ...
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label11" class="Label" >Kilometraje:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentKilometraje" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label12" class="Label" >Año Actividad:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentAnoActividad" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
                                 <tr>
                                   <td align="right" width="220px">
                                        <label id="Label14" class="Label" >Observaciones:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                ...
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label15" class="Label" >Fotografia:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
            ...
            <table id= "tblMinibusesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Minibuses</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td>
                        ...
                        <div id="divSearchDetailMinibusesPopup" class="panel" style="width:537px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchRutFilter" class="Label" >Patente:</label>
                                                </td>
                                                <td>
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="lblSearchApellidosFilter" class="Label" >Marca:</label>
                                                </td>
                                                <td>
