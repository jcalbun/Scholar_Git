<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ayudante.aspx.cs" Inherits="TCSWebSite.Ayudante" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/Ayudantes.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmAyudantees" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblAyudante" class="Label" >Id:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtAyudanteId" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRAyudanteId" runat="server">Id</label>
                            </th>
                            <th align="center">
    ...
    <%--popup--%>
    <div id="divSearchAyudanteesPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblAyudanteesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Ayudantes</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td>
                        ...
                        <div id="divSearchDetailAyudanteesPopup" class="panel" style="width:637px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                ...
                <tr>
                    <td>
                        <div id="divSearchAyudanteesPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchAyudanteesTableHeader">
                                    <tr>
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchAyudanteesPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchManufacturersPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
