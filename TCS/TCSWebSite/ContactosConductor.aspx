<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosConductor.aspx.cs" Inherits="TCSWebSite.ContactosConductor" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/ContactosConductor.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmContactosConductor" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblConductor" class="Label" >Conductor:</label>
                                            </td>
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRIdConductor" runat="server">Id Conductor</label>
                            </th>
                            <th align="center">
                                <label id="lblSRConductor" runat="server">Conductor</label>
                            </th>
                            <th align="center">
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentContactoConductorTitle">
                            ...
                            <table>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label3" class="Label" >Conductor:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdConductor" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentConductor" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
    ...
    <div id="divSearchContactosPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblContactosConductorsPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                ...
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchConductorFilter" class="Label" >Conductor:</label>
                                                </td>
                                                <td>
                                                    <input id="txtSearchConductorFilter" class="TextBoxWrite" type="text"  
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchConductorsPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchConductorsPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
