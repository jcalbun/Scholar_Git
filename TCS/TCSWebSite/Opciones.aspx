<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Opciones.aspx.cs" Inherits="TCSWebSite.Opciones" %>
...
<body onload="onFormLoad();">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblOpcion" class="Label" >Opcion:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtCodigoOpcionFilter" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchOpcion" style="cursor:hand;" class="ButtonLupa" onclick="onBtnShowSearchOpcionesPopupClick();">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding-left:5px">
                                                <input id="txtNombreOpcionFilter" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>  
                                            <td>
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSROpcionId" runat="server">Opcion</label>
                            </th>
                            <th align="center">
                                <label id="lblSRRut" runat="server">Nombre</label>
                            </th>
                             <th align="center">
                                <label id="Label5" runat="server">Url</label>
                            </th>
                        </tr>
                    </thead>
                </table>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label7" class="Label" >Opcion:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentCodigoOpcion" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentNombreOpcion" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>  
                                    <td>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label2" class="Label" >Url:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentUrl" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr>
    ...
    <%--popup--%>
    <div id="divSearchOpcionesPopup" style="display:none; height:auto; width:auto; max-width: 600px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Opciones</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                                ...
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchRutFilter" class="Label" >Opcion:</label>
                                                </td>
                                                <td>
                    ...
                    <td>
                        <div id="divSearchOpcionesPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchOpcionesPopupTableHeader">
                                    <tr>
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchOpcionesPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
