<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosEstablecimiento.aspx.cs" Inherits="TCSWebSite.ContactosEstablecimiento" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/ContactosEstablecimiento.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmContactosEstablecimiento" runat="server" autocomplete="off">
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRIdEstablecimiento" runat="server">Id Establecimiento</label>
                            </th>
                            <th align="center">
                                <label id="lblSREstablecimiento" runat="server">Establecimiento</label>
                            </th>
                            <th align="center">
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseDivCurrentDetail();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentContactoEstablecimientoTitle">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdEstablecimiento" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEstablecimiento" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentObservaciones" type="text" class="TextBoxWrite" maxlength="10" style="width:180px;height:60px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                </tr> 
    ...
    <div id="divSearchContactosPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblContactosEstablecimientosPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
