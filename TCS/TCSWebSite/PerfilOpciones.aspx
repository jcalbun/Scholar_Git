<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerfilOpciones.aspx.cs" Inherits="TCSWebSite.PerfilOpciones" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/PerfilOpciones.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmOpciones" runat="server" autocomplete="off">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblOpcion" class="Label" >Perfil:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtOpcionId" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchOpcion" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label1" class="Label" >Opcion:</label>
                                            </td> 
                                            <td style="padding-left:5px">
        ...
        <div id="divResults" class="panel" style="display:none;height:auto; width:100%; max-height:160px;">
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thOpcionesFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSROpcionId" runat="server">Perfil</label>
                            </th>
                            <th align="center">
                                <label id="Label3" runat="server">Opcion</label>
                            </th>
                        </tr>
                    </thead>
                </table>
            ...
            <div id="divSearchResultsTableContainer" style="overflow:auto;width:auto;max-height:145px">
                <table id = "tblOpcionesResults" class="GridTable" style="width:700px;">
                    <tbody>
                    </tbody>
                </table>
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentOpcionTitle">
                        Perfil Opcion Seleccionado
                    </td>
                    <td align="right">
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="Text1" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label9" class="Label" >Opcion:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="Text3" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>   
                                    <td style="width:5px;  padding-left:0px;" align="left">&nbsp;</td>  
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="chkTieneContrato" type="checkbox" tabindex="3"/>
                                    </td>   
                                </tr> 
                            </table>
                        </td>
    ...
    <%--popup--%>
    <div id="divSearchOpcionesPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblOpcionesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td class="style6">
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Perfil Opcion</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td class="style6">
                        ...
                        <div id="divSearchDetailOpcionesPopup" class="panel" style="width:637px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                    ...
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td>
                                                    <label id="lblSearchApellidosFilter" class="Label" >Opcion:</label>
                                                </td>
                                                <td>
                ...
                <tr>
                    <td class="style6">
                        <div id="divSearchOpcionesPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchOpcionesTableHeader">
                                    <tr>
                                        <th class="style4">
                                            Perfil
                                        </th>
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchOpcionesPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchManufacturersPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
