<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Egresos.aspx.cs" Inherits="TCSWebSite.Egresos" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/Egresos.js" type="text/javascript"></script>
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblContrato" class="Label" >Id Egreso:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtEgreso" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label3" class="Label" >Tipo Egreso:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <select id="ddlTipoEgreso" style="width:180px" onclick="">
                    ...
                    <tr>
                        <td>
                            <table>
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label6" class="Label" >Id Egreso:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentEgreso" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label8" class="Label" >Tipo Engreso:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <select id="ddlCurrentTipoEgreso" style="width:180px" onclick="">
                                                    <option value="Select" selected="selected">Seleccionar</option>    
                                                    <option value="R">Repuesto</option>    
                                                    <option value="S">Sueldo</option>    
                                                    <option value="O">Otro</option>    
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Egresos</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                                ...
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchRutFilter" class="Label" >Egreso:</label>
                                                </td>
                                                <td>
