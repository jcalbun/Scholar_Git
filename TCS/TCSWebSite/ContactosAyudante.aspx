<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosAyudante.aspx.cs" Inherits="TCSWebSite.ContactosAyudante" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    <head id="Head1" runat="server">
        ...
        <script src="js/ContactosAyudante.js" type="text/javascript"></script>
...
<body onload="onFormLoad();">
    <form id="frmContactosAyudante" runat="server" autocomplete="off">
    ...
    <div style="height: 496px"> 
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="lblAyudante" class="Label" >Ayudante:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtAyudante" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchAyudante" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label7" class="Label" >Contacto:</label>
                                            </td>
                                            <td style="padding-left:5px">
                                                <input id="txtContacto" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>
                                            <td>
                                                <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                                    <tr>
                                                        <td>
                                                            <div id="btnShowSearchContacto" style="cursor:hand;" class="ButtonLupa" onclick="">...</div>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>  
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label1" class="Label" >Direccion:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                        ...
                                        <tr>
                                            <td align="right" width="120px">
                                                <label id="Label2" class="Label" >Telefono:</label>
                                            </td> 
                                            <td style="padding-left:5px">
                                                <input id="txtTelefono" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" 
                                                    onkeyup  = ""
                                                    onchange = ""/>
                                            </td>   
                                        </tr>
            ...
            <div id="divSearchResultsTableTitles" style="width:auto;height:auto;">  
                ...
                <table class="GridTable" style="width:700px;">
                    <thead id="thResultsFixedHead">
                        <tr>
                            <th align="center">
                                <label id="lblSRIdAyudante" runat="server">Id Ayudante</label>
                            </th>
                            <th align="center">
                                <label id="lblSRAyudante" runat="server">Ayudante</label>
                            </th>
                            <th align="center">
                                <label id="lblSRIdContacto" runat="server">Id Contacto</label>
                            </th>
                            <th align="center">
                                <label id="lblSRDireccion" runat="server">Direccion</label>
                            </th>
                            <th align="center">
                                <label id="lblSRTelefono" runat="server">Telefono</label>
                            </th>
                        </tr>
                    </thead>
                </table>
        ...
        <div id="divCurrentTitle" class="tdLikeMenu" style="display:none;width:100%;cursor:hand;" onclick="CollapseResultsPanel();">
            <table border="0px" cellpadding="0px" cellspacing="0px" style=" width:100%">
                <tr>
                    ...
                    <td align="left" class="LabelWhite" id="lblCurrentContactoAyudanteTitle">
                            ...
                            <table>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label3" class="Label" >Ayudante:</label>
                                    </td>
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentIdAyudante" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentAyudante" type="text" class="TextBoxRead" maxlength="10" style="width:180px" 
                                            onkeyup  = ""
                                            onchange = ""/>
                                    </td>
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label8" class="Label" >Direccion:</label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentDireccion1" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" />
                                    </td>   
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label9" class="Label" ></label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentDireccion2" type="text" class="TextBoxWrite" maxlength="10" style="width:180px" />                        </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                    ...
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTelefono1" type="text" class="TextBoxWrite" maxlength="10" style="width:180px"/>
                                    </td>   
                                </tr>
                                <tr>
                                    <td align="right" width="220px">
                                        <label id="Label12" class="Label" ></label>
                                    </td> 
                                    <td style="padding-left:5px">
                                        <input id="txtCurrentTelefono2" type="text" class="TextBoxWrite" maxlength="10" style="width:180px"/>
                                    </td>   
                                </tr> 
                                <tr>
                                    <td align="right" width="220px">
                                ...
                                <tr>
                                    <td align="right" width="120px">
                                        <label id="Label5" class="Label" >Observaciones:</label>
                                    </td> 
                                    <td style="padding-left:5px">
     ...
     <%--popup--%>
    <div id="divSearchContactosPopup" style="display:none; height:auto; width:auto; max-width: 550px; max-height:400px; min-height:50px; overflow:hidden; margin:5px;">
            <table id= "tblContactosAyudantesPopup" border="0px" cellpadding="0px" cellspacing="0px">
                <tr>
                    <td>
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr>
                                <td class="tdLikeMenu" align="center">
                                    <label class="LabelWhite" style="margin-left:3px">Busqueda Contactos</label>
                                </td>
                            </tr>
                        </table>
                    </td> 
                ...
                <tr>
                    <td>
                        ...
                        <div id="divSearchDetailContactosPopup" class="panel" style="width:637px; height:65px; overflow:hidden" >
                            <table style="width:auto; margin:5px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                <tr>
                                    <td>
                                        <table style="margin:0px" border="0px" align="left" cellpadding="0px" cellspacing="0px" >
                                            <tr>
                                                <td >
                                                    <label id="lblSearchAyudanteFilter" class="Label" >Ayudante:</label>
                                                </td>
                                                <td>
                                                    <input id="txtSearchAyudanteFilter" class="TextBoxWrite" type="text"  
                ...
                <tr>
                    <td>
                        <div id="divSearchContactosPopUpSearchResults" style="max-height:150px; overflow:auto;">
                            <table class="GridTable">
                                <thead id="thSearchContactosTableHeader">
                                    <tr>
                        ...
                        <table border="0px" cellpadding="0px" cellspacing="0px" style="width: 100%">
                            <tr align="center">
                                <td style="padding-top:4px; padding-right:17px;padding-bottom:4px;">
                                    <div id="BtnCloseSearchAyudantesPopUp" class="linkButton" style="display:inline; margin-left: 5px;" onclick="window.frames.iframeContent.onBtnCloseSearchAyudantesPopUpClick()">                                            
                                        Cerrar
                                    </div>
                                </td>
                            </tr>
